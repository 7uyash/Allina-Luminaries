      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          <img
            ...
            alt="Service 1"
            className="w-full h-64 md:h-80 object-cover rounded-[20px] hover:scale-105 transition-transform duration-300 cursor-pointer"
          />
          <img
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/705b571ddf0b00bbe95bbd35ad06fe99444869c7?placeholderIfAbsent=true"
            alt="Service 2"
            className="w-full h-64 object-cover rounded-[20px] hover:scale-105 transition-transform duration-300 cursor-pointer"
          />
          <img
          ...
          <img
            ...
            alt="Service 4"
            className="w-full h-48 object-cover rounded-[20px] hover:scale-105 transition-transform duration-300 cursor-pointer md:col-span-2"
          />
          <img
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/36a9f71c893e9fc9b0dee30c1f639521042b9bba?placeholderIfAbsent=true"
            alt="Service 5"
            className="w-full h-48 object-cover rounded-[20px] hover:scale-105 transition-transform duration-300 cursor-pointer"
          />
          <img
